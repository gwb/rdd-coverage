...
(Keele ``An Overview of Geographically Discontinuous Treatment Assignments with an Application to Children's Health Insurance'', 2017) build on the methods of \cite{imbensrdd}, also using local linear regression to estimate the treatment effects at any point along the border.
