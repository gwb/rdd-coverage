...
and show evidence of a price discontinuity between two neighboring school districts.
...
In Section~\ref{sec:NYC_example}, we apply our methodology to an empirical example, using a publicly available dataset of property sales in NYC to determine whether school districts affect property prices.
...
The question remains: what is the most appropriate choice of weights? In this section, we motivate and consider six possible choices of \(\weightb(\sentinel)\), and explore interpretations, advantages, and disadvantages. A summary of their properties is provided in Table \ref{table:estimator_properties}.
...
\end{longtable}
    	...
    	\begin{figure}
\centering
\includegraphics{../figures/wiggly_boundaries_setup.png}
...
\end{figure}
    	...
    	\begin{figure}
\centering
\includegraphics{../figures/wiggly_boundaries_posteriors.png}
...
In other words, can we reject the null hypothesis that the first derivative of the treatment effect is zero?
...
\\    \hline
	\end{tabular}
	\caption{Table of posterior mean averaged over 10,000 simulations, posterior standard deviation and true value for each average treatment effect estimand as the wiggliness of the border is increased in the simulations of Section \ref{sec:wiggly_border}.}
\end{table}
\end{landscape}
\restoregeometry
