...
The projection method then considers a univariate RDD along \(s_1\).
...
In geographical settings, a discontinuous change in the density of units at the border is not unusual: for example a border could run alongside a park, or a small body of water, or even a busy road, therefore with zero population density on one side of the border.
