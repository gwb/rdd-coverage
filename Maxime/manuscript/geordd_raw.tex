...
It is a commonly held belief that the quality of schools has a significant effect on the price of nearby housing.
...
When these forcing variables are spatial, i.e. treatment and control units are separated by a geographical border, we face a Geographical regression discontinuity design (GeoRDD).
...
\cite{keele2015enhancing} formalize this approach, and use the matching methods of \cite{zubizarreta2012using} to estimate the effect of ballot initiatives on voter turnout in Milwaukee, Wisconsin.
...
but other spatial models could also be suitable.
