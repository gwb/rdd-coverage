...
Our implementation of the methods proposed in this paper uses the \textt{GaussianProcesses.jl} package \citep{fairbrother2018gaussianprocesses} for the julia programming language \citep{bezanson2017julia} and is made available on the first author's GitHub account.
...
% \begin{figure}[tbp]
    % \centering
    % % \includegraphics{figures/geordd/mississippi_counts.pdf}
    % \includegraphics[height=0.5\textheight]{figures/geordd/mississippi_counts.pdf}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{figures/geordd/sales_map.png}
...
% \begin{figure}[tb]
    % \centering
    % \includegraphics[width=0.5\textwidth]{figures/geordd/sales_histogram_19-27.pdf}
...
\begin{figure}[tb]
    \centering
    \includegraphics[height=0.35\textheight]{figures/geordd/NYC_cliff_face.png}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{figures/geordd/placebo_invvar.pdf}
    \caption{
