...
\begin{table}[tbp]
    ...
    \begin{tabular}{ll}
        ...
        \(\invvar\) uncalibrated & 0.002 \\
        \(\invvar\) calibrated   & 0.005 \\
        \hline
    \end{tabular}
    \egroup
    \caption{
...
House prices increase going across the border from districts 18 to 17, 23 to 17, 28 to 29, and 29 to 26.
...
The estimated size of this effect varies: zero or negligible in some cases, such as between districts 15, 20, 21, and 22; and quite pronounced in others, such as a 16\% price increase from 29 to 26, or 17\% from 18 to 17.
...
\begin{landscape}
    \begin{table}[p]
        ...
        \begin{tabular}{r|lllllll}
            \hline
\( \mathbf{13} \)& \( \mathbf{14:}~-0.29 \pm 0.10 \)& \( \mathbf{15:}~+0.09 \pm 0.08 \)& \( \mathbf{16:}~-0.06 \pm 0.07 \)& \( \mathbf{17:}~-0.15 \pm 0.09 \)\\
\( \mathbf{14} \)& \( \mathbf{13:}~+0.29 \pm 0.10 \)& \( \mathbf{16:}~-0.07 \pm 0.12 \)& \( \mathbf{24:}~-0.35 \pm 0.19 \)& \( \mathbf{32:}~-0.05 \pm 0.13 \)\\
\( \mathbf{15} \)& \( \mathbf{13:}~-0.09 \pm 0.08 \)& \( \mathbf{17:}~-0.17 \pm 0.11 \)& \( \mathbf{20:}~+0.09 \pm 0.06 \)& \( \mathbf{22:}~+0.35 \pm 0.14 \)\\
\( \mathbf{16} \)& \( \mathbf{13:}~+0.06 \pm 0.07 \)& \( \mathbf{14:}~+0.07 \pm 0.12 \)& \( \mathbf{17:}~-0.08 \pm 0.08 \)& \( \mathbf{23:}~-0.10 \pm 0.08 \)& \( \mathbf{32:}~+0.04 \pm 0.08 \)\\
\( \mathbf{17} \)& \( \mathbf{13:}~+0.15 \pm 0.09 \)& \( \mathbf{15:}~+0.17 \pm 0.11 \)& \( \mathbf{16:}~+0.08 \pm 0.08 \)& \( \mathbf{18:}~-0.16 \pm 0.07 \)& \( \mathbf{22:}~+0.01 \pm 0.08 \)& \( \mathbf{23:}~-0.29 \pm 0.11 \)\\
\( \mathbf{18} \)& \( \mathbf{17:}~+0.16 \pm 0.07 \)& \( \mathbf{19:}~-0.13 \pm 0.14 \)& \( \mathbf{22:}~+0.05 \pm 0.07 \)& \( \mathbf{23:}~-0.08 \pm 0.10 \)\\
\( \mathbf{19} \)& \( \mathbf{18:}~+0.13 \pm 0.14 \)& \( \mathbf{23:}~-0.01 \pm 0.09 \)& \( \mathbf{24:}~+0.34 \pm 0.13 \)& \( \mathbf{27:}~+0.20 \pm 0.06 \)& \( \mathbf{32:}~+0.27 \pm 0.15 \)\\
\( \mathbf{20} \)& \( \mathbf{15:}~-0.09 \pm 0.06 \)& \( \mathbf{21:}~+0.06 \pm 0.06 \)& \( \mathbf{22:}~-0.09 \pm 0.09 \)\\
\( \mathbf{21} \)& \( \mathbf{20:}~-0.06 \pm 0.06 \)& \( \mathbf{22:}~-0.05 \pm 0.05 \)\\
\( \mathbf{22} \)& \( \mathbf{15:}~-0.35 \pm 0.14 \)& \( \mathbf{17:}~-0.01 \pm 0.08 \)& \( \mathbf{18:}~-0.05 \pm 0.07 \)& \( \mathbf{20:}~+0.09 \pm 0.09 \)& \( \mathbf{21:}~+0.05 \pm 0.05 \)\\
\( \mathbf{23} \)& \( \mathbf{16:}~+0.10 \pm 0.08 \)& \( \mathbf{17:}~+0.29 \pm 0.11 \)& \( \mathbf{18:}~+0.08 \pm 0.10 \)& \( \mathbf{19:}~+0.01 \pm 0.09 \)& \( \mathbf{32:}~-0.07 \pm 0.08 \)\\
\( \mathbf{24} \)& \( \mathbf{14:}~+0.35 \pm 0.19 \)& \( \mathbf{19:}~-0.34 \pm 0.13 \)& \( \mathbf{25:}~+0.25 \pm 0.15 \)& \( \mathbf{27:}~-0.17 \pm 0.12 \)& \( \mathbf{28:}~+0.17 \pm 0.07 \)& \( \mathbf{30:}~+0.10 \pm 0.06 \)& \( \mathbf{32:}~-0.01 \pm 0.09 \)\\
\( \mathbf{25} \)& \( \mathbf{24:}~-0.25 \pm 0.15 \)& \( \mathbf{26:}~+0.09 \pm 0.05 \)& \( \mathbf{28:}~-0.09 \pm 0.09 \)& \( \mathbf{29:}~+0.06 \pm 0.13 \)& \( \mathbf{30:}~-0.45 \pm 0.22 \)\\
...
\( \mathbf{32} \)& \( \mathbf{14:}~+0.05 \pm 0.13 \)& \( \mathbf{16:}~-0.04 \pm 0.08 \)& \( \mathbf{19:}~-0.27 \pm 0.15 \)& \( \mathbf{23:}~+0.07 \pm 0.08 \)& \( \mathbf{24:}~+0.01 \pm 0.09 \)\\
            \hline
        \end{tabular}
        \caption{
